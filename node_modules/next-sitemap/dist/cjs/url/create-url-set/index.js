 ...
 */
exports.entityEscapedUrl = (path) => path
    .replace(/&/g, '&amp;')
    .replace(/'/g, '&apos;')
    .replace(/"/g, '&quot;')
    .replace(/>/g, '&gt;')
...
exports.absoluteUrl = (siteUrl, path, trailingSlash) => {
    ...
    return exports.entityEscapedUrl(url);
};
/**
...
exports.createUrlSet = (config, manifest) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (i18n) {
        ...
        const replaceDefaultLocale = util_1.createDefaultLocaleReplace(defaultLocale);
        urlSet = urlSet.map(replaceDefaultLocale);
    }
    // Remove the urls based on config.exclude array
    if (config.exclude && config.exclude.length > 0) {
        urlSet = array_1.removeIfMatchPattern(urlSet, config.exclude);
    }
