...
describe('createUrlSet', () => {
    test('without exclusion', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield __1.createUrlSet(config_2.sampleConfig, manifest_1.sampleManifest);
    ...
    test('with exclusion', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield __1.createUrlSet(Object.assign(Object.assign({}, config_2.sampleConfig), { exclude: ['/', '/page-0', '/page-2'] }), manifest_1.sampleManifest);
        expect(urlset).toStrictEqual([
            {
                changefreq: 'daily',
                lastmod: expect.any(String),
    ...
    test('with i18n exclusion', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield __1.createUrlSet(Object.assign(Object.assign({}, config_2.sampleConfig), { exclude: ['/', '/page-0', '/page-2', '/about', '/fr*'] }), manifest_1.sampleI18nManifest);
        expect(urlset).toStrictEqual([
            {
                changefreq: 'daily',
                lastmod: expect.any(String),
    ...
    test('with wildcard exclusion', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield __1.createUrlSet(Object.assign(Object.assign({}, config_2.sampleConfig), { exclude: ['/page*'] }), manifest_1.sampleManifest);
        expect(urlset).toStrictEqual([
            {
                changefreq: 'daily',
                lastmod: expect.any(String),
    ...
    test('without trailing slash', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield __1.createUrlSet(Object.assign(Object.assign({}, config_2.sampleConfig), { trailingSlash: false }), manifest_1.sampleManifest);
        expect(urlset).toStrictEqual([
            {
                changefreq: 'daily',
                lastmod: expect.any(String),
    ...
    test('with trailing slash', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield __1.createUrlSet(Object.assign(Object.assign({}, config_2.sampleConfig), { trailingSlash: true }), manifest_1.sampleManifest);
        expect(urlset).toStrictEqual([
            {
                changefreq: 'daily',
                lastmod: expect.any(String),
    ...
    test('with custom transform', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield __1.createUrlSet(Object.assign(Object.assign({}, config_2.sampleConfig), { trailingSlash: true, transform: (_, url) => {
    ...
    test('with alternateRefs', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield __1.createUrlSet(Object.assign(Object.assign({}, config_2.sampleConfig), { siteUrl: 'https://example.com/', alternateRefs: [
    ...
    test('with additionalPaths', () => __awaiter(void 0, void 0, void 0, function* () {
        const transform = (config, url) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            return config_1.transformSitemap(config, url);
        });
        ...
        const urlset = yield __1.createUrlSet(config, manifest_1.sampleManifest);
    ...
    test('with next i18n enabled', () => __awaiter(void 0, void 0, void 0, function* () {
        const urlset = yield __1.createUrlSet(config_2.sampleConfig, manifest_1.sampleI18nManifest);
        expect(urlset).toStrictEqual([
